...
def fix_install_name(destdir, path, dependency_list, args):
    ...
    for install_name in get_install_name(full_path):
        ...
        subprocess.check_call(["i686-apple-darwin12-install_name_tool", "-id",
                              new_install_name, full_path])
...
def main():
    ...
    parser.add_argument('--filelist', help="List of relative files", default="/build/deps/filelist.txt")
